		  ...
		  <el-main style="background: linear-gradient(to bottom, #fff , #eee);">
			 ...
			 <el-col :span="22" :offset="1">
			  <el-col :span="8" >
			  	...
			  	<div style="float: left;min-height: 60px;width:100%" id="qg_card0">
			  		<div style="float: left;width:60px">
				  		...
				  		<el-button type="info" style="padding: 8px 10px;margin: 5px 0px 0px -13px;" round><i class="el-icon-chat-line-round"></i> 留言</el-button>
			  		</div>
			  		<div style="float: right;width:73%;color: #333;font-size: 15px">
			  			...
			  			<div style="float: right;margin: 10px 10px 0px 10px">
				  			<el-link type="primary"  class="qg_zkpl0"   ><i class="el-icon-chat-line-square"></i> 0</el-link>
				  			<el-link type="primary"   id="qg_zkpl0"  @click="zkpl(0)" style="display:none">展开评论</el-link>
